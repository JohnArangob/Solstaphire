...
public class AiEnemyNow : MonoBehaviour
{
    ...
    void EstadoSeguir()
    {
        ...
        custode.SetFloat("velocidad2", 1);
        custode.SetBool("atacando", false);
    ...
    void EstadoAtacar()
    {
        ...
        custode.SetFloat("velocidad", 0);
        custode.SetBool("atacando", true);
        custode.SetFloat("velocidad2", 0);
        Atacar();
